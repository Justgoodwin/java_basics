...
public class Main {
    private static final String DATA_FILE = "C:\\Users\\Nikita\\IdeaProjects\\java_basics" +
            "\\ExceptionsDebuggingAndTesting\\homework_2\\SPBMetro\\src\\main\\resources\\map.json";
    ...
    public static void main(String[] args) {
        ...
        JsonParser jsonParser = new JsonParser("https://skillbox-java.github.io");

        jsonParser.htmlCodeReader();
        PrintJson printJson = new PrintJson("data/metro.json");
        printJson.printJsonFile();
